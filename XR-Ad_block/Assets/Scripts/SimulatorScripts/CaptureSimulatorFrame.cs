...
public class CaptureSimulatorFrame : MonoBehaviour
{
    ...
    private void Update()
    {
        FrameData frame = new FrameData
        {
            ...
            currentPose = new Pose(simulatorCamera.transform.position, simulatorCamera.transform.rotation),
            currentRay = new Ray(simulatorCamera.transform.position, simulatorCamera.transform.forward),
